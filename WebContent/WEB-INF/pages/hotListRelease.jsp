...
<div class="container min-height">
  ...
  <div class="col-md-12 text-right">
   <!--  <input type="button" value="Process Done" class="btn btn-primary" onclick="saveShortlistReleaseHR();"/> -->
    <input type="button" value="Process Done" data-toggle="modal" data-target="#ProcessDone"  class="btn btn-primary"/>
       ...
       <div class="modal-body">
											...
											<div class="modal-footer">
												...
												<button type="button" class="btn btn-primary"
													data-dismiss="modal" onclick="saveShortlistReleaseHR();"  >OK</button>
											</div>
										</div>
...
function saveShortlistReleaseHR(){
    document.getElementById("shortlistedReleaseFormId").action = "processDoneHotlisted";
