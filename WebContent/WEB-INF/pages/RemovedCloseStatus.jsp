	...
	<jsp:include page="commonJsp/Footer.jsp" />
		...
		<script>
			...
			function getValues(rollNumber) {
				...
				var action = "getUnApproveUserValues?rollNumber=" + rollNumber;
			...
			function getInternshipValues(rollNumber) {
				...
				var action = "getUnApproveInternshipList?rollNumber=" + rollNumber;
				xhttp.open("POST", action, true);
				xhttp.send();
			}
			...
			function getExperienceValues(rollNumber) {
				...
				var action = "getUnApproveExperienceList?rollNumber=" + rollNumber;
				xhttp.open("POST", action, true);
				xhttp.send();
			}
			...
			function getCVValues(rollNumber) {
				...
				var action = "getUnApproveCVList?rollNumber=" + rollNumber;
				xhttp.open("POST", action, true);
				xhttp.send();
			}
	
			function getApproveInfoValues() {
				var xhttp = new XMLHttpRequest();
				xhttp.onreadystatechange = function() {
					if (this.readyState == 4 && this.status == 200) {
						this.responseText;
				...
				var action = "getUnApproveInfoValues";
				xhttp.open("POST", action, true);
				xhttp.send();
			}
