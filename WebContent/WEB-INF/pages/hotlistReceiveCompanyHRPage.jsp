...
<div class="container min-height">
  ...
  <div class="col-md-12 text-right">
    ...
    <div class="modal fade" id="cover-letter" role="dialog">
     ...
     <input type="button" value="Save Hotlist Release" data-toggle="modal" data-target="#save-shortlist-release"  class="btn btn-primary" id="saveCompHRReleaseId"/>
...
<script>
   function getUserDetailsByRolNo(rollNo){
	   var xhttp = new XMLHttpRequest();
		...
		var action = "getUserDetailsByRolNo?rollNumber=0" + rollNo;
   ...
   function downloadCVs(){
	 ...
	 // alert("shrtlisted--"+txt);  
	  ...
	  document.getElementById("downloadCVformId").action = "downloadHotRMCv";
   ...
   function saveHRShortlisted(){
		 ...
		 // alert("shrtlisted--"+txt);  
		  ...
		  document.getElementById("downloadCVformId").action = "saveHRHotlisted";
		  document.getElementById("downloadCVformId").method = "post";
		  document.getElementById("downloadCVformId").submit(); 
