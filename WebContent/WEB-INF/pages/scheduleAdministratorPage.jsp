            ...
            <div class="clearfix">
                <div class="pull-left">
                    <ul class="list-inline link-list">
                        ...
                        <li>Scheduling Administrator</li>
                    </ul>
                </div>
...
<div class="content">
  <center>  <h2><b>Scheduling Administrator</b></h2></center>
  <%-- <center><input type="button" value="Assign Dynamic Role" data-toggle="modal" data-target="#assignDynamicRole" class="btn btn-primary button_width"></center></br> --%>
	
</div>
</div>


    <div class="modal fade" id="assignDynamicRole" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="modal-title text-left">Assign Role</h4>
				</div>
...
<!-- <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="saveAssignRoles();">Assign</button> -->
