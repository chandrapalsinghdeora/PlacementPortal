...
<body>
 ...
 <input type="button" id="saveVerifyId"
							...
							<input type="button" id="saveReleaseId"
								...
								onclick="saveShortlistedBySuperRM();" data-toggle="modal"
								data-target="#save-shortlist-release" class="btn btn-primary" />
	...
	<script>
			...
			function updateFlag(valArr) {
				...
				document.getElementById("updateFlag").action = "updateFlagBySuperRMGD";
			...
			$(function() {
				$('#shortListBtn').click(function() {
					...
					$("#updateApplyId").val();
					 ...
					 if ($(".considerCheck").is(":checked")) {
						...
						document.getElementById("updateFlag").action = "shortListBySuperRMGD";
						document.getElementById("updateFlag").method = "post";
						document.getElementById("updateFlag").submit();
			 ...
			 function saveShortlistedBySuperRM(){
				 // alert("rm");	
				  ...
				  document.getElementById("shortlistformId").action = "saveShortlistedBySuperRMGD"; //  saveShortlisted
			 ...
			 function saveShortlistFinalBySuperRM1(){
				    document.getElementById("shortlistedReleaseFormId").action = "saveReleaseShortlistedBySuperRmGD";
				...
				function saveSendMail(){
					 document.getElementById("shortlistedReleaseFormId").action = "saveSendMailBySuperRMGD";
					 document.getElementById("shortlistedReleaseFormId").method = "post";
					 document.getElementById("shortlistedReleaseFormId").submit(); 
				}
				...
				function saveHotlistBySuperRm1(){
					  ...
					  var notshortlisted= document.getElementById("notShortListedIds");
					  notshortlisted.value=notShortelisted; 
					  document.getElementById("hotlistformId").action = "saveHotlistedBySuperRMGD";
				...
				function saveProcessDone(){
				    document.getElementById("hotListReleaseFormId").action = "processDoneHotlistedBySuperRMGD";
					 ...
					 if ($("input[name=shortlisted]").is(":checked")) {
					    ...
					    if (txt!=null && txt.length>0) {
					    	var shortlisted= document.getElementById("shortListIdsSelected");
							  ...
							  var notshortlisted= document.getElementById("notShortListedIds");
							  notshortlisted.value=notShortelisted; 
							  document.getElementById("shortlistformId").action = "removeShortlistedBySuperRMGD1";
							  document.getElementById("shortlistformId").method = "post";
							  document.getElementById("shortlistformId").submit();
						}else{
