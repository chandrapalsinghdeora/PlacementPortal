...
<title>Indian Institute of Management Ahmedabad (IIMA) | Home - IIMA</title>
			...
			<div class="col-md-10">
				...
				<div class="tab-content">
					...
					<div class="table-responsive">
						...
						<div class="space"></div>
						<div class="col-md-12"><input type="button" id="verifyBtn" value="Verify" 
    ...
    <div class="col-md-12 text-right">
     <input type="button" id="saveVerifyId"
      ...
      <input type="button" id="saveReleaseId" value="Save Shortlist Details" onclick="saveShortlistedBySuperRM();"   class="btn btn-primary" />
  ...
  <div class="space"></div>
  <div class="col-md-12 text-right">
  <!--   <input type="button" value="Shortlist Release" class="btn btn-primary" onclick="saveShortlistReleaseBySuperRm2();"/>
    ...
    <table id="main-fourum7" class="table table-bordered display nowrap">
      ...
      <input type="hidden" value="${shrt.hotListId}" name="hotListId"/>
        <tr>
          <td>${shrt.rollNumber}</td>
          <td><a href="#" data-toggle="modal" data-target="#closed-status-email" onclick="getUserDetailsByRolNo1('${shrt.rollNumber}');"> ${shrt.emailID}</a>
           </td>
          <td> ${shrt.name} </td>
          <td> ${shrt.preference} </td>
          <td>${shrt.status}</td>
    ...
    <div class="space"></div>
    <div class="col-md-12 text-right">
      <input type="button" id="saveReleaseId" value="Save HotList Release" onclick="saveHotlistBySuperRM2()"  class="btn btn-primary"  />
      ...
      <div class="modal-content">
        ...
        <div class="row"><div class="col-md-12 text-center"> <label>Student Congratulation</label> </div></div>
         ...
         <div class="modal-footer text-center">
          <button type="button" class="btn btn-primary" onclick="saveHotlistBySuperRM2();">OK</button>
          <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
        </div>
      </div>
   ...
   <!-- View Released Hotlist div starts -->
		...
		<script>
			...
			function updateFlag(valArr) {
				...
				document.getElementById("updateFlag").action = "updateFlagBySuperRM2";
			...
			$(function() {
				$('#shortListBtn').click(function() {
					...
					$("#updateApplyId").val();
					 if ($(".considerCheck").is(":checked")) {
						...
						document.getElementById("updateFlag").action = "shortListBySuperRM2";
						document.getElementById("updateFlag").method = "post";
						document.getElementById("updateFlag").submit();
			 ...
			 function saveShortlistedBySuperRM(){
				  ...
				  document.getElementById("shortlistformId").action = "saveShortlistedBySuperRM2"; //  saveShortlisted
			 ...
			 function saveShortlistReleaseBySuperRm2(){
				    document.getElementById("shortlistedReleaseFormId").action = "saveReleaseShortlistedBySuperRm2";
				...
				function saveSendMail(){
					 document.getElementById("shortlistedReleaseFormId").action = "saveSendMailBySuperRM2";
					 document.getElementById("shortlistedReleaseFormId").method = "post";
					 document.getElementById("shortlistedReleaseFormId").submit(); 
				}
				...
				function saveHotlistBySuperRM2(){
					  ...
					  var notshortlisted= document.getElementById("notShortListedIds");
					  notshortlisted.value=notShortelisted; 
					  document.getElementById("hotlistformId").action = "saveHotlistedBySuperRM2";
					 ...
					 if ($("input[name=shortlisted]").is(":checked")) {
					    ...
					    if (txt!=null && txt.length>0) {
					    	var shortlisted= document.getElementById("shortListIdsSelected");
							  ...
							  var notshortlisted= document.getElementById("notShortListedIds");
							  notshortlisted.value=notShortelisted; 
							  document.getElementById("shortlistformId").action = "removeShortlistedBySuperRM2";
							  document.getElementById("shortlistformId").method = "post";
							  document.getElementById("shortlistformId").submit();
						}else{
							alert("No data available.");
