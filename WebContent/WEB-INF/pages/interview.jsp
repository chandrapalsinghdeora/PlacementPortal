...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" id="savetheinterview" method="post">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">Interview Question & Answers</div>
		...
		<div class="marg">
			<input type="button" value="Submit" onclick="saveit()"
				class="btn btn-primary" /> <input type="button" id="cancel"
...
<script>
		...
		function saveit(){
			...
			if($("#companyId").val()==0 ){
				...
				document.getElementById("savetheinterview").action = "saveinterview";
				document.getElementById("savetheinterview").method = "post";
				document.getElementById("savetheinterview").submit();
			}
		}
	 	...
	 	$(document).ready(function() {
	    	...
	    	$("#add-panel").click(function() {
				...
				if(x<11) {
				   var domElement = $(' <div class="panel panel-primary"><div class="panel-heading">Interview Question & Answers  ' +x+ '</div>'+data1+'</div></div>');
