	...
	<jsp:include page="commonJsp/Footer.jsp" />
		...
		<script>
			...
			function getValues(rollNumber) {
				...
				var action = "getApproveUserValues?rollNumber=" + rollNumber;
			...
			function getInternshipValues(rollNumber) {
				...
				var action = "getApproveInternshipList?rollNumber=" + rollNumber;
				xhttp.open("POST", action, true);
				xhttp.send();
			}
			...
			function getExperienceValues(rollNumber) {
				...
				var action = "getApproveExperienceList?rollNumber=" + rollNumber;
				xhttp.open("POST", action, true);
				xhttp.send();
			}
			...
			function getCVValues(rollNumber) {
				...
				var action = "getApproveCVList?rollNumber=" + rollNumber;
				xhttp.open("POST", action, true);
				xhttp.send();
			}
			...
			function getInfoValues() {
				...
				var action = "getApproveInfoValues";
				xhttp.open("POST", action, true);
				xhttp.send();
			}
