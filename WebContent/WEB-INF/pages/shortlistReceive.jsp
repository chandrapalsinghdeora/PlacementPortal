...
<div class="closed-status">
  <div class="container min-height">
    ...
    <div class="col-md-12 text-right">
      ...
      <input type="button" id="saveReleaseId" value="Save Shortlist Release" onclick="getGreetings('${cmpRoleId}');" data-toggle="modal" data-target="#save-shortlist-release"  class="btn btn-primary" />
      ...
      <div class="modal-content">
        ...
        <div class="row"><div class="col-md-12 text-center"> <label>Student Congratulation</label> </div></div>
         ...
         <div class="modal-footer text-center">
          <button type="button" class="btn btn-primary" onclick="saveShortlisted();">OK</button>
          <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
        </div>
      </div>
...
<script>
   ...
   function saveShortlisted(){
	  ...
	  var notShorted = document.getElementsByName("notShortlisted");
	   ...
	   // alert("Shortelisted--"+txt);
	   // alert("notShortelisted--"+notShortelisted);	    
