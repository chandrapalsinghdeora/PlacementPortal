...
@Controller
public class ApprovedCloseStatusController {/*

	@Autowired
	CloseStatusService closeStatusService;
	
	@RequestMapping(value ="/getApprovedCloseStatus",method = RequestMethod.GET)
	public ModelAndView getAllCloseStatusDetails(ModelAndView model,HttpServletRequest req){
		...
		model.setViewName("ApprovedCloseStatus");
		return model;
		
	}
	
	@RequestMapping(value="/getApproveUserValues")
	...
	@RequestMapping(value="/getApproveInternshipList" ,method = RequestMethod.POST)
	...
	@RequestMapping(value="/getApproveExperienceList" ,method = RequestMethod.POST)
	...
	@RequestMapping(value="/getApproveCVList" ,method = RequestMethod.POST)
	...
	@RequestMapping(value="/getApproveInfoValues")
