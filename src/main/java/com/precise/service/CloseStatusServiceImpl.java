...
@Service("closeStatusService")
@Transactional
public class CloseStatusServiceImpl implements CloseStatusService {
	...
	public String getSelectedUserValues(String shortListId,int compRoleId,boolean rankFlag){
		return closeStatusdao.getUserData(shortListId,compRoleId,rankFlag);
	}

	public String getSelectedUserHRList(String shortListId,int compRoleId){
		return closeStatusdao.getSelectedUserHRList(shortListId,compRoleId);
	}
	
	public String getSelectedUserHRHotList(String shortListId,int compRoleId){
		return closeStatusdao.getSelectedUserHRHotList(shortListId,compRoleId);
	}
	...
	public String getSelectedUserHotList(String hotListId,int compRoleId){
		return closeStatusdao.getSelectedUserHotList(hotListId,compRoleId);
	}
